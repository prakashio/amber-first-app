...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Note App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= AhS5M8rGbG6ZA1fQbniYtI_AGWClkoz8ytW76B9tJc0
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("note-app.log", "w"))
  #
  #
end
